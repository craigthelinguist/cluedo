...
public class SuggestionDialog extends JDialog implements ActionListener{
	...
	public SuggestionDialog() {
		...
		gConstraints.insets = new Insets(0, 50, 5, 5);
		...
		gConstraints.insets = new Insets(0, 50, 5, 0);
		...
		gConstraints.insets = new Insets(0, 8, 5, 5); //change second parameter to line them up with the other options
		gConstraints.gridx = 0;
		...
		gConstraints.insets = new Insets(0, -20, 5, 5);
		gConstraints.gridx = 0;
		...
		gConstraints.insets = new Insets(0, -25, 0, 5);
		gConstraints.gridx = 1;
		gConstraints.gridy = 6;
